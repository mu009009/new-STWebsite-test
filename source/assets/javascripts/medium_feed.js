    ...
    $("#medium-recent-posts").rss("http://medium.com/feed/stratifyd",
      {
        ...
        entryTemplate: '<div class="col-md-6 col-lg-4 col-sm-6 feed-item"><a target="_blank" href="{url}" class="card"><div class="post-image-container">{teaserImage}</div><div class="post-title highlighted-content">{title}</div><div class="post-body body-copy-small">{shortBodyPlain}</div></a></div>',
        ssl: true,
        filter: function(entry, tokens) {
          return tokens.index > 0
        }
