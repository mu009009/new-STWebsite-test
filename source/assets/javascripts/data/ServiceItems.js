const ServiceItems = [
  ...
  {key: 6, name: 'CRM', icon: "crm.png", categories: ['ALL', 'GAP']},
  {key: 7, name: 'Multi-Channel', icon: "multi_channel_marketing.png", categories: ['ALL', 'REACH']},
  {key: 8, name: 'Teleservices', icon: "teleservices.png", categories: ['ALL', 'LEADS']},
  {key: 9, name: 'Lead Gen', icon: "lead_generation.png", categories: ['ALL', 'FUNNEL']},
  ...
  {key: 17, name: 'Event Management', icon: "event_management.png", categories: ['ALL', 'LEADS']},
  {key: 18, name: 'Direct Mail', icon: "directmail.png", categories: ['ALL', 'GAP']},
];
