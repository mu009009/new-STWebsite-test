 ...
 * 
 * EXTENDED with TLS support and the ability to change the port
    ...
    function __construct($options=array()){
		...
		if ($this->_use_tls) {
			if (!ldap_start_tls($this->_conn)) {
				throw new adLDAPException('Bind to Active Directory failed. TLS didn´t work. AD said: ' . $this->get_last_error()); 
			}
		}
